...
class NetworkXModel(object):
    ...
    def visualize_network(self,
        ...
        if legend:
            # muscles
            ax.text(-3, -0.5, 'TRIlong') 
            ax.text(-1, -0.5, 'TRIlat') 
            ax.text(1, -0.5, 'TRImed') 
            ax.text(-4, 11, 'DELT1')
            ax.text(-2, 11, 'BIClong') 
            ax.text(-0, 11, 'BICshort') 
            ax.text(2, 11, 'BRA')  

            # neurons
            legend_elements = [Line2D([0], [0], marker='o', color='w', markerfacecolor='k', label='C', markersize=10),
                   Line2D([0], [0], marker='o', color='w', markerfacecolor='r', label='Mn', markersize=10)]
            if "II" in include:
                legend_elements.append(Line2D([0], [0], marker='o', color='w', markerfacecolor='y', label='Ia,II aff', markersize=10))
                legend_elements.append(Line2D([0], [0], marker='o', color='w', markerfacecolor='b', label='Ia,II In', markersize=10))
            else:
                legend_elements.append(Line2D([0], [0], marker='o', color='w', markerfacecolor='y', label='Ia aff', markersize=10))
                if "IaIn" in include: 
                    legend_elements.append(Line2D([0], [0], marker='o', color='w', markerfacecolor='b', label='Ia In', markersize=10))
            if "Rn" in include:
                legend_elements.append(Line2D([0], [0], marker='o', color='w', markerfacecolor='m', label='Rn', markersize=10)) 
