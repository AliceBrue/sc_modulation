'''  environment to simulate OpenSim models
Adapted version of osim-rl repository. 
...
class OsimModel(object):
    ...
    def get_state_dict(self):
        ...
        if self.model.getMuscles().getSize() != 0:
            ...
            for i in range(self.model.getMuscles().getSize()):
                ...
                obs['muscles'][name]['active_force'] = muscle.getActiveFiberForce(
                    self.state)
    ...
    def reset(self):
        ...
        if self.save_kin is not None:
            ...
            #self.joint_reaction.getForceStorage().reset(0)
    ...
    def save_simulation(self, base_dir):
        ...
        #self.joint_reaction.printResults('joint_reaction', base_dir)
